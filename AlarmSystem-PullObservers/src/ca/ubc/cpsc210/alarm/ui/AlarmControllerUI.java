...
import ca.ubc.cpsc210.alarm.model.ConsoleWriter;
...
public class AlarmControllerUI extends JFrame {
	...
	public AlarmControllerUI() {
		...
		ac.addAlarmObserver(new ConsoleWriter());
		...
		public void actionPerformed(ActionEvent evt) {
			...
			try {
				if (selected.equals(FILE_DESCRIPTOR)) 
					...
					ScreenPrinter sp = new ScreenPrinter(AlarmControllerUI.this); 
					desktop.add(sp);
					EventLog.getInstance().addObserver(sp);
					lp = sp;
				}
